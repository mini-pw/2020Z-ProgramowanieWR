...
Do porównywania użyte zostaną dane USMortality opisujące statystki śmiertelności obywaletli USA, dane Crimes(package Ecdat), które opisują przestępstwa w stanie Północna Karolina oraz mapa USA(USAboundaries)
