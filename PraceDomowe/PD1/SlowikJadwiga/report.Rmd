...
Powyższe wyniki można przedstawić na wykresie w następujący sposób:

```{r, echo=FALSE, out.width="1000px", out.height="400px", out.align="center"}
...
plot_final_data %>% 
  ggplot(aes(x=plot, y=mean, group=package, fill=package)) + 
  geom_bar(stat='identity', position=position_dodge(1)) +
  theme_classic()

#knitr::kable(plot_final_data)

```

Na powyższym wykresie można zauważyć, że w większości przypadków najlepszą szybkość uzyskuje pakiet `ggplot`.
Wyjątkiem jest jedynie generowanie wykresu słupkowego. W tym przypadku (nieznacznie) wygrał pakiet `lattice`.