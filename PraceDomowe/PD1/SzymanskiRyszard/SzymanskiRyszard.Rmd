...
## ggplot2
```{r, echo=FALSE}
create_ggplot_scatter()
```

## lattice
```{r, echo=FALSE}
create_lattice_scatter()
```

## graphics
```{r, echo=FALSE}
create_graphics_scatter()
```
...
## ggplot2
```{r, echo=FALSE}
create_ggplot_barplot()
```

## lattice
```{r, echo=FALSE}
create_lattice_barplot()
```

## graphics
```{r, echo=FALSE}
create_graphics_barplot()
```
...
## ggplot2
```{r, echo=FALSE}
create_ggplot_boxplot()
```

## lattice
```{r, echo=FALSE}
create_lattice_boxplot()
```

## graphics
```{r, echo=FALSE}
create_graphics_boxplot()
```
